...
import net.identidade.dashpanels_expanded.PanelsExpandedHoldInteractions;
...
public class SingleLeverModule extends Module implements IExternalUpdatable, IInput, IModuleLuaObject {
    ...
    public void tick(Level level, BlockPos blockPos, BlockState blockState) {
        ...
        this.renderSignal = org.joml.Math.lerp(this.renderSignal, Mth.map((float)this.signal, 0.0F, 15.0F, 0.0F, 0.31F), 0.5F);
